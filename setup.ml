...
(* OASIS_START *)
(* DO NOT EDIT (digest: 18c5b1f5d120c20b97baf479bc2e71e0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Modules for representing and manipulating extracellular neural\nrecording data.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\128\162\ne\244A\214+\153\144\030\152a\204L\137";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
